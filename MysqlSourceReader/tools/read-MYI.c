// 源码来自于 : https://github.com/heguangyu5/heguangyu5.github.io/blob/master/mysql/read-MYI.c
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
...
int main(int argc, char *argv[])
{
    ...
    fd = open("/Users/yimutian/Lvsi/github/When-the-grapes-are-ripe/MysqlSourceReader/tools/sherk.MYI", O_RDONLY);
    if (fd == -1) {
        perror("open");
        return 0;
    }
